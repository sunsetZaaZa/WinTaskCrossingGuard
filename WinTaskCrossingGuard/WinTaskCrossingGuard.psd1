@{
    ...
    FunctionsToExport = @(
        ...
        'Get-WtcgHttpErrorStatusCode',
        'Test-WtcgTransientHttpStatusCode',
        'Invoke-WtcgHttpRequestWithRetry',
        'Send-WtcgGenericHttpPayload',
        'Test-WtcgTelemetryEventAllowed',
        'Select-WtcgTelemetryEvent',
        'ConvertTo-WtcgGenericHttpTelemetryPayload',
        'Resolve-WtcgElasticBulkUri',
        'Get-WtcgElasticAuthHeader',
        'ConvertTo-WtcgTelemetryExportResultSummary',
